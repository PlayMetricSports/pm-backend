const EmailVerificationOTPTemplate = (code) => {
    const template = `
        <!DOCTYPE html>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                ...
                                                <p style="font-size:16px;line-height:26px;margin:16px 0;font-weight:300;color:#404040">
                                                    Someone recently requested a OTP for email verification of your K12 Online School account. If this was you, you can verify your email with this verification code:
                                                </p>
